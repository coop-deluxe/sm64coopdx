...
// 0x030227C0
static const Vtx waluigi_cap_seg3_vertex_030227C0[] = {
...
// 0x030228C0
static const Vtx waluigi_cap_seg3_vertex_030228C0[] = {
...
// 0x030229B0
static const Vtx waluigi_cap_seg3_vertex_030229B0[] = {
    {{{   -76,     84,    -60}, 0, {     0,      0}, {0xd5, 0x6e, 0xd3, 0xff}}},
    {{{   -41,    144,     64}, 0, {     0,      0}, {0xdc, 0x79, 0x00, 0xff}}},
    {{{    76,     84,    -60}, 0, {     0,      0}, {0x2a, 0x6c, 0xcf, 0xff}}},
...
// 0x03022AA0
static const Vtx waluigi_cap_seg3_vertex_03022AA0[] = {
    {{{    86,      1,    -60}, 0, {     0,      0}, {0x20, 0x86, 0xfe, 0xff}}},
    {{{   -86,      1,    -60}, 0, {     0,      0}, {0xce, 0x8c, 0xf6, 0xff}}},
    {{{   -52,      0,   -118}, 0, {     0,      0}, {0xd2, 0x9d, 0xc1, 0xff}}},
    {{{    33,     17,    109}, 0, {     0,      0}, {0xfb, 0x84, 0xea, 0xff}}},
...
const Gfx waluigi_cap_seg3_dl_03022D10[] = {
    ...
    gsSPCopyLightEXT(1, 5), //gsSPLight(&waluigi_cap_seg3_lights_0301CF08.l, 1),
    gsSPCopyLightEXT(2, 6), //gsSPLight(&waluigi_cap_seg3_lights_0301CF08.a, 2),
...
const Gfx waluigi_cap_seg3_dl_03022F48[] = {
    ...
    gsSPCopyLightEXT(1, 5), //gsSPLight(&waluigi_cap_seg3_lights_0301CF38.l, 1),
    gsSPCopyLightEXT(2, 6), //gsSPLight(&waluigi_cap_seg3_lights_0301CF38.a, 2),
...
const Gfx waluigi_cap_seg3_dl_03023298[] = {
    ...
    gsSPTexture(0x0F80, 0x07C0, 0, G_TX_RENDERTILE, G_ON),
    gsSPCopyLightEXT(1, 5), //gsSPLight(&waluigi_cap_seg3_lights_0301CF20.l, 1),
    gsSPCopyLightEXT(2, 6), //gsSPLight(&waluigi_cap_seg3_lights_0301CF20.a, 2),
    gsSPDisplayList(waluigi_cap_seg3_dl_03022B30),
    gsSPDisplayList(waluigi_cap_seg3_dl_03022B68),
    gsSPDisplayList(waluigi_cap_seg3_dl_03022CC8),
    gsSPTexture(0x0F80, 0x07C0, 0, G_TX_RENDERTILE, G_OFF),
