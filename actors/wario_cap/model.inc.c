...
const Gfx wario_cap_seg3_dl_03022D10[] = {
    ...
    gsSPCopyLightsPlayerPart(SHIRT), //gsSPLight(&wario_cap_seg3_lights_0301CF08.a, 2),
...
const Gfx wario_cap_seg3_dl_03022F48[] = {
    ...
    gsSPCopyLightsPlayerPart(SHIRT), //gsSPLight(&wario_cap_seg3_lights_0301CF38.a, 2),
