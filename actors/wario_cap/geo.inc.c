...
const GeoLayout warios_cap_geo[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, wario_cap_material_revert_render_settings),
      ...
      GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, wario_cap_material_revert_render_settings),
   GEO_CLOSE_NODE(),
   GEO_END(),
};
