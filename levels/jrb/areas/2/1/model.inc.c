...
static const Lights1 jrb_seg7_lights_0700D360 = gdSPDefLights1(
    0x50, 0x66, 0x58,
    0xc8, 0xff, 0xdc, 0x49, 0x49, 0x49
);

// 0x0700D378 - 0x0700D3F8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700D378, 0x0041a760, 37817, 0x0000d378, 128);

// 0x0700D3F8 - 0x0700D4E8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700D3F8, 0x0041a760, 37817, 0x0000d3f8, 240);

// 0x0700D4E8 - 0x0700D5D8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700D4E8, 0x0041a760, 37817, 0x0000d4e8, 240);

// 0x0700D5D8 - 0x0700D6D8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700D5D8, 0x0041a760, 37817, 0x0000d5d8, 256);

// 0x0700D6D8 - 0x0700D7C8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700D6D8, 0x0041a760, 37817, 0x0000d6d8, 240);

// 0x0700D7C8 - 0x0700D878
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700D7C8, 0x0041a760, 37817, 0x0000d7c8, 176);

// 0x0700D878 - 0x0700D928
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700D878, 0x0041a760, 37817, 0x0000d878, 176);

// 0x0700D928 - 0x0700D968
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700D928, 0x0041a760, 37817, 0x0000d928, 64);

// 0x0700D968 - 0x0700DA28
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700D968, 0x0041a760, 37817, 0x0000d968, 192);

// 0x0700DA28 - 0x0700DB28
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700DA28, 0x0041a760, 37817, 0x0000da28, 256);

// 0x0700DB28 - 0x0700DC08
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700DB28, 0x0041a760, 37817, 0x0000db28, 224);

// 0x0700DC08 - 0x0700DCF8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700DC08, 0x0041a760, 37817, 0x0000dc08, 240);

// 0x0700DCF8 - 0x0700DDD8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700DCF8, 0x0041a760, 37817, 0x0000dcf8, 224);

// 0x0700DDD8 - 0x0700DED8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700DDD8, 0x0041a760, 37817, 0x0000ddd8, 256);

// 0x0700DED8 - 0x0700DFD8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700DED8, 0x0041a760, 37817, 0x0000ded8, 256);

// 0x0700DFD8 - 0x0700E0C8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700DFD8, 0x0041a760, 37817, 0x0000dfd8, 240);

// 0x0700E0C8 - 0x0700E1C8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700E0C8, 0x0041a760, 37817, 0x0000e0c8, 256);

// 0x0700E1C8 - 0x0700E298
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700E1C8, 0x0041a760, 37817, 0x0000e1c8, 208);

// 0x0700E298 - 0x0700E398
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700E298, 0x0041a760, 37817, 0x0000e298, 256);

// 0x0700E398 - 0x0700E458
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700E398, 0x0041a760, 37817, 0x0000e398, 192);

// 0x0700E458 - 0x0700E518
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700E458, 0x0041a760, 37817, 0x0000e458, 192);

// 0x0700E518 - 0x0700E558
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700E518, 0x0041a760, 37817, 0x0000e518, 64);

// 0x0700E558 - 0x0700E658
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700E558, 0x0041a760, 37817, 0x0000e558, 256);

// 0x0700E658 - 0x0700E6E8
ROM_ASSET_LOAD_VTX(jrb_seg7_vertex_0700E658, 0x0041a760, 37817, 0x0000e658, 144);
