...
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700BF90, 0x004614d0, 37742, 0x0000bf90, 256);

// 0x0700C090 - 0x0700C190
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C090, 0x004614d0, 37742, 0x0000c090, 256);

// 0x0700C190 - 0x0700C270
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C190, 0x004614d0, 37742, 0x0000c190, 224);

// 0x0700C270 - 0x0700C2B0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C270, 0x004614d0, 37742, 0x0000c270, 64);
