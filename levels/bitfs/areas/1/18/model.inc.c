...
static const Lights1 bitfs_seg7_lights_0700C490 = gdSPDefLights1(
    0x62, 0x7f, 0x7f,
    0xc4, 0xff, 0xff, 0x49, 0x49, 0x49
);

// 0x0700C4A8 - 0x0700C4C0
static const Lights1 bitfs_seg7_lights_0700C4A8 = gdSPDefLights1(
    0x32, 0x7f, 0x59,
    0x65, 0xff, 0xb2, 0x49, 0x49, 0x49
);

// 0x0700C4C0 - 0x0700C540
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C4C0, 0x004614d0, 37742, 0x0000c4c0, 128);

// 0x0700C540 - 0x0700C580
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C540, 0x004614d0, 37742, 0x0000c540, 64);

// 0x0700C580 - 0x0700C5C0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C580, 0x004614d0, 37742, 0x0000c580, 64);

// 0x0700C5C0 - 0x0700C600
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C5C0, 0x004614d0, 37742, 0x0000c5c0, 64);

// 0x0700C600 - 0x0700C700
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C600, 0x004614d0, 37742, 0x0000c600, 256);

// 0x0700C700 - 0x0700C7E0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C700, 0x004614d0, 37742, 0x0000c700, 224);

// 0x0700C7E0 - 0x0700C8E0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C7E0, 0x004614d0, 37742, 0x0000c7e0, 256);

// 0x0700C8E0 - 0x0700C9E0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C8E0, 0x004614d0, 37742, 0x0000c8e0, 256);

// 0x0700C9E0 - 0x0700CAE0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700C9E0, 0x004614d0, 37742, 0x0000c9e0, 256);

// 0x0700CAE0 - 0x0700CBD0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700CAE0, 0x004614d0, 37742, 0x0000cae0, 240);

// 0x0700CBD0 - 0x0700CCB0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700CBD0, 0x004614d0, 37742, 0x0000cbd0, 224);

// 0x0700CCB0 - 0x0700CD90
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700CCB0, 0x004614d0, 37742, 0x0000ccb0, 224);

// 0x0700CD90 - 0x0700CE70
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700CD90, 0x004614d0, 37742, 0x0000cd90, 224);

// 0x0700CE70 - 0x0700CF60
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700CE70, 0x004614d0, 37742, 0x0000ce70, 240);

// 0x0700CF60 - 0x0700D060
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700CF60, 0x004614d0, 37742, 0x0000cf60, 256);

// 0x0700D060 - 0x0700D160
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D060, 0x004614d0, 37742, 0x0000d060, 256);

// 0x0700D160 - 0x0700D260
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D160, 0x004614d0, 37742, 0x0000d160, 256);

// 0x0700D260 - 0x0700D360
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D260, 0x004614d0, 37742, 0x0000d260, 256);

// 0x0700D360 - 0x0700D440
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D360, 0x004614d0, 37742, 0x0000d360, 224);

// 0x0700D440 - 0x0700D520
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D440, 0x004614d0, 37742, 0x0000d440, 224);

// 0x0700D520 - 0x0700D620
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D520, 0x004614d0, 37742, 0x0000d520, 256);

// 0x0700D620 - 0x0700D720
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D620, 0x004614d0, 37742, 0x0000d620, 256);

// 0x0700D720 - 0x0700D810
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D720, 0x004614d0, 37742, 0x0000d720, 240);

// 0x0700D810 - 0x0700D910
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D810, 0x004614d0, 37742, 0x0000d810, 256);

// 0x0700D910 - 0x0700D9F0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D910, 0x004614d0, 37742, 0x0000d910, 224);

// 0x0700D9F0 - 0x0700DAF0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700D9F0, 0x004614d0, 37742, 0x0000d9f0, 256);

// 0x0700DAF0 - 0x0700DBF0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700DAF0, 0x004614d0, 37742, 0x0000daf0, 256);

// 0x0700DBF0 - 0x0700DCE0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700DBF0, 0x004614d0, 37742, 0x0000dbf0, 240);

// 0x0700DCE0 - 0x0700DDC0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700DCE0, 0x004614d0, 37742, 0x0000dce0, 224);

// 0x0700DDC0 - 0x0700DEA0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700DDC0, 0x004614d0, 37742, 0x0000ddc0, 224);

// 0x0700DEA0 - 0x0700DFA0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700DEA0, 0x004614d0, 37742, 0x0000dea0, 256);

// 0x0700DFA0 - 0x0700E0A0
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700DFA0, 0x004614d0, 37742, 0x0000dfa0, 256);

// 0x0700E0A0 - 0x0700E180
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700E0A0, 0x004614d0, 37742, 0x0000e0a0, 224);

// 0x0700E180 - 0x0700E260
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700E180, 0x004614d0, 37742, 0x0000e180, 224);

// 0x0700E260 - 0x0700E350
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700E260, 0x004614d0, 37742, 0x0000e260, 240);

// 0x0700E350 - 0x0700E430
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700E350, 0x004614d0, 37742, 0x0000e350, 224);

// 0x0700E430 - 0x0700E460
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_0700E430, 0x004614d0, 37742, 0x0000e430, 48);
