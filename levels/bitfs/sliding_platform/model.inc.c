...
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_070113A8, 0x004614d0, 37742, 0x000113a8, 256);

// 0x070114A8 - 0x070114E8
ROM_ASSET_LOAD_VTX(bitfs_seg7_vertex_070114A8, 0x004614d0, 37742, 0x000114a8, 64);
