...
ROM_ASSET_LOAD_VTX(ttc_seg7_vertex_07011120, 0x0042cf20, 42199, 0x00010e00, 128);

// 0x070111A0 - 0x070112A0
ROM_ASSET_LOAD_VTX(ttc_seg7_vertex_070111A0, 0x0042cf20, 42199, 0x000111a0, 256);
