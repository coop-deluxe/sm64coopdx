...
ROM_ASSET_LOAD_VTX(ttc_seg7_vertex_0700FCB0, 0x0042cf20, 42199, 0x0000fcb0, 128);

// 0x0700FD30 - 0x0700FE30
ROM_ASSET_LOAD_VTX(ttc_seg7_vertex_0700FD30, 0x0042cf20, 42199, 0x0000fd30, 256);

// 0x0700FE30 - 0x0700FE90
ROM_ASSET_LOAD_VTX(ttc_seg7_vertex_0700FE30, 0x0042cf20, 42199, 0x0000fe30, 96);

// 0x0700FE90 - 0x0700FED0
ROM_ASSET_LOAD_VTX(ttc_seg7_vertex_0700FE90, 0x0042cf20, 42199, 0x0000fe90, 64);
