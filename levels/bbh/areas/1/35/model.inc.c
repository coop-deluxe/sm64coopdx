...
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701B850, 0x00371c40, 68724, 0x0001b850, 240);

// 0x0701B940 - 0x0701B9B0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701B940, 0x00371c40, 68724, 0x0001b940, 112);

// 0x0701B9B0 - 0x0701BAB0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701B9B0, 0x00371c40, 68724, 0x0001b9b0, 256);

// 0x0701BAB0 - 0x0701BAF0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701BAB0, 0x00371c40, 68724, 0x0001bab0, 64);

// 0x0701BAF0 - 0x0701BBF0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701BAF0, 0x00371c40, 68724, 0x0001baf0, 256);

// 0x0701BBF0 - 0x0701BCF0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701BBF0, 0x00371c40, 68724, 0x0001bbf0, 256);

// 0x0701BCF0 - 0x0701BDF0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701BCF0, 0x00371c40, 68724, 0x0001bcf0, 256);

// 0x0701BDF0 - 0x0701BEE0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701BDF0, 0x00371c40, 68724, 0x0001bdf0, 240);

// 0x0701BEE0 - 0x0701BFD0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701BEE0, 0x00371c40, 68724, 0x0001bee0, 240);

// 0x0701BFD0 - 0x0701C0D0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701BFD0, 0x00371c40, 68724, 0x0001bfd0, 256);

// 0x0701C0D0 - 0x0701C1B0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C0D0, 0x00371c40, 68724, 0x0001c0d0, 224);

// 0x0701C1B0 - 0x0701C2A0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C1B0, 0x00371c40, 68724, 0x0001c1b0, 240);

// 0x0701C2A0 - 0x0701C380
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C2A0, 0x00371c40, 68724, 0x0001c2a0, 224);

// 0x0701C380 - 0x0701C460
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C380, 0x00371c40, 68724, 0x0001c380, 224);

// 0x0701C460 - 0x0701C560
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C460, 0x00371c40, 68724, 0x0001c460, 256);

// 0x0701C560 - 0x0701C650
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C560, 0x00371c40, 68724, 0x0001c560, 240);

// 0x0701C650 - 0x0701C730
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C650, 0x00371c40, 68724, 0x0001c650, 224);

// 0x0701C730 - 0x0701C820
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C730, 0x00371c40, 68724, 0x0001c730, 240);

// 0x0701C820 - 0x0701C8D0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C820, 0x00371c40, 68724, 0x0001c820, 176);

// 0x0701C8D0 - 0x0701C990
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C8D0, 0x00371c40, 68724, 0x0001c8d0, 192);

// 0x0701C990 - 0x0701CA80
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701C990, 0x00371c40, 68724, 0x0001c990, 240);

// 0x0701CA80 - 0x0701CB70
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701CA80, 0x00371c40, 68724, 0x0001ca80, 240);

// 0x0701CB70 - 0x0701CC60
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701CB70, 0x00371c40, 68724, 0x0001cb70, 240);

// 0x0701CC60 - 0x0701CD50
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701CC60, 0x00371c40, 68724, 0x0001cc60, 240);

// 0x0701CD50 - 0x0701CE40
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701CD50, 0x00371c40, 68724, 0x0001cd50, 240);

// 0x0701CE40 - 0x0701CF30
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701CE40, 0x00371c40, 68724, 0x0001ce40, 240);

// 0x0701CF30 - 0x0701D030
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701CF30, 0x00371c40, 68724, 0x0001cf30, 256);

// 0x0701D030 - 0x0701D130
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D030, 0x00371c40, 68724, 0x0001d030, 256);

// 0x0701D130 - 0x0701D1B0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D130, 0x00371c40, 68724, 0x0001d130, 128);

// 0x0701D1B0 - 0x0701D2B0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D1B0, 0x00371c40, 68724, 0x0001d1b0, 256);

// 0x0701D2B0 - 0x0701D3B0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D2B0, 0x00371c40, 68724, 0x0001d2b0, 256);

// 0x0701D3B0 - 0x0701D4B0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D3B0, 0x00371c40, 68724, 0x0001d3b0, 256);

// 0x0701D4B0 - 0x0701D5B0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D4B0, 0x00371c40, 68724, 0x0001d4b0, 256);

// 0x0701D5B0 - 0x0701D6A0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D5B0, 0x00371c40, 68724, 0x0001d5b0, 240);

// 0x0701D6A0 - 0x0701D7A0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D6A0, 0x00371c40, 68724, 0x0001d6a0, 256);

// 0x0701D7A0 - 0x0701D820
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D7A0, 0x00371c40, 68724, 0x0001d7a0, 128);

// 0x0701D820 - 0x0701D910
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D820, 0x00371c40, 68724, 0x0001d820, 240);

// 0x0701D910 - 0x0701D980
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D910, 0x00371c40, 68724, 0x0001d910, 112);

// 0x0701D980 - 0x0701D9C0
ROM_ASSET_LOAD_VTX(bbh_seg7_vertex_0701D980, 0x00371c40, 68724, 0x0001d980, 64);
