...
ROM_ASSET_LOAD_VTX(wdw_seg7_vertex_07013250, 0x0040ed70, 45590, 0x00013250, 240);

// 0x07013340 - 0x070133F0
ROM_ASSET_LOAD_VTX(wdw_seg7_vertex_07013340, 0x0040ed70, 45590, 0x00013340, 176);
