...
ROM_ASSET_LOAD_VTX(hmc_seg7_vertex_0701FDC8, 0x003d0dc0, 89137, 0x0001fdc8, 240);

// 0x0701FEB8 - 0x0701FF68
ROM_ASSET_LOAD_VTX(hmc_seg7_vertex_0701FEB8, 0x003d0dc0, 89137, 0x0001feb8, 176);
