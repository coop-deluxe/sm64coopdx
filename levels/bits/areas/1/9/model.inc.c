...
ROM_ASSET_LOAD_VTX(bits_seg7_vertex_07008DB8, 0x0046c3a0, 47442, 0x00008db8, 240);

// 0x07008EA8 - 0x07008F58
ROM_ASSET_LOAD_VTX(bits_seg7_vertex_07008EA8, 0x0046c3a0, 47442, 0x00008ea8, 176);
