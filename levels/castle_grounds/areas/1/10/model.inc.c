...
ROM_ASSET_LOAD_VTX(castle_grounds_seg7_vertex_0700C2A0, 0x0044abc0, 39442, 0x0000c2a0, 64);

// 0x0700C2E0 - 0x0700C3A0
ROM_ASSET_LOAD_VTX(castle_grounds_seg7_vertex_0700C2E0, 0x0044abc0, 39442, 0x0000c2e0, 192);
