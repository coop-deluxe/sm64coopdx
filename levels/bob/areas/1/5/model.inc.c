...
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700AA10, 0x003fc2b0, 38830, 0x0000aa10, 224);

// 0x0700AAF0 - 0x0700ABF0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700AAF0, 0x003fc2b0, 38830, 0x0000aaf0, 256);

// 0x0700ABF0 - 0x0700ACF0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700ABF0, 0x003fc2b0, 38830, 0x0000abf0, 256);

// 0x0700ACF0 - 0x0700ADF0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700ACF0, 0x003fc2b0, 38830, 0x0000acf0, 256);

// 0x0700ADF0 - 0x0700AED0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700ADF0, 0x003fc2b0, 38830, 0x0000adf0, 224);

// 0x0700AED0 - 0x0700AFC0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700AED0, 0x003fc2b0, 38830, 0x0000aed0, 240);

// 0x0700AFC0 - 0x0700B0C0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700AFC0, 0x003fc2b0, 38830, 0x0000afc0, 256);

// 0x0700B0C0 - 0x0700B1B0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700B0C0, 0x003fc2b0, 38830, 0x0000b0c0, 240);

// 0x0700B1B0 - 0x0700B2B0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700B1B0, 0x003fc2b0, 38830, 0x0000b1b0, 256);

// 0x0700B2B0 - 0x0700B3B0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700B2B0, 0x003fc2b0, 38830, 0x0000b2b0, 256);

// 0x0700B3B0 - 0x0700B4B0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700B3B0, 0x003fc2b0, 38830, 0x0000b3b0, 256);

// 0x0700B4B0 - 0x0700B5A0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700B4B0, 0x003fc2b0, 38830, 0x0000b4b0, 240);

// 0x0700B5A0 - 0x0700B6A0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700B5A0, 0x003fc2b0, 38830, 0x0000b5a0, 256);

// 0x0700B6A0 - 0x0700B790
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700B6A0, 0x003fc2b0, 38830, 0x0000b6a0, 240);

// 0x0700B790 - 0x0700B890
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700B790, 0x003fc2b0, 38830, 0x0000b790, 256);

// 0x0700B890 - 0x0700B970
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700B890, 0x003fc2b0, 38830, 0x0000b890, 224);

// 0x0700B970 - 0x0700BA70
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700B970, 0x003fc2b0, 38830, 0x0000b970, 256);

// 0x0700BA70 - 0x0700BB50
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700BA70, 0x003fc2b0, 38830, 0x0000ba70, 224);

// 0x0700BB50 - 0x0700BC50
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700BB50, 0x003fc2b0, 38830, 0x0000bb50, 256);

// 0x0700BC50 - 0x0700BD30
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700BC50, 0x003fc2b0, 38830, 0x0000bc50, 224);

// 0x0700BD30 - 0x0700BE30
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700BD30, 0x003fc2b0, 38830, 0x0000bd30, 256);

// 0x0700BE30 - 0x0700BF30
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700BE30, 0x003fc2b0, 38830, 0x0000be30, 256);

// 0x0700BF30 - 0x0700BF90
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700BF30, 0x003fc2b0, 38830, 0x0000bf30, 96);

// 0x0700BF90 - 0x0700C080
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700BF90, 0x003fc2b0, 38830, 0x0000bf90, 240);

// 0x0700C080 - 0x0700C170
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C080, 0x003fc2b0, 38830, 0x0000c080, 240);

// 0x0700C170 - 0x0700C250
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C170, 0x003fc2b0, 38830, 0x0000c170, 224);

// 0x0700C250 - 0x0700C350
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C250, 0x003fc2b0, 38830, 0x0000c250, 256);

// 0x0700C350 - 0x0700C440
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C350, 0x003fc2b0, 38830, 0x0000c350, 240);

// 0x0700C440 - 0x0700C4A0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C440, 0x003fc2b0, 38830, 0x0000c440, 96);

// 0x0700C4A0 - 0x0700C5A0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C4A0, 0x003fc2b0, 38830, 0x0000c4a0, 256);

// 0x0700C5A0 - 0x0700C690
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C5A0, 0x003fc2b0, 38830, 0x0000c5a0, 240);

// 0x0700C690 - 0x0700C790
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C690, 0x003fc2b0, 38830, 0x0000c690, 256);

// 0x0700C790 - 0x0700C870
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C790, 0x003fc2b0, 38830, 0x0000c790, 224);

// 0x0700C870 - 0x0700C950
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C870, 0x003fc2b0, 38830, 0x0000c870, 224);

// 0x0700C950 - 0x0700CA40
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700C950, 0x003fc2b0, 38830, 0x0000c950, 240);

// 0x0700CA40 - 0x0700CB20
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700CA40, 0x003fc2b0, 38830, 0x0000ca40, 224);

// 0x0700CB20 - 0x0700CC10
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700CB20, 0x003fc2b0, 38830, 0x0000cb20, 240);

// 0x0700CC10 - 0x0700CD00
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700CC10, 0x003fc2b0, 38830, 0x0000cc10, 240);

// 0x0700CD00 - 0x0700CE00
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700CD00, 0x003fc2b0, 38830, 0x0000cd00, 256);

// 0x0700CE00 - 0x0700CE40
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700CE00, 0x003fc2b0, 38830, 0x0000ce00, 64);

// 0x0700CE40 - 0x0700CEC0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700CE40, 0x003fc2b0, 38830, 0x0000ce40, 128);

// 0x0700CEC0 - 0x0700CF80
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700CEC0, 0x003fc2b0, 38830, 0x0000cec0, 192);

// 0x0700CF80 - 0x0700CFC0
ROM_ASSET_LOAD_VTX(bob_seg7_vertex_0700CF80, 0x003fc2b0, 38830, 0x0000cf80, 64);
