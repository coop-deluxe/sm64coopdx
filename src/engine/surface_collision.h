...
If no ceiling is found, returns the default height limit of 20000.
|descriptionEnd| */
...
If no floor is found, returns the default floor height of -11000.
|descriptionEnd| */
...
If no water is found, returns the default height of -11000.
|descriptionEnd| */
f32 find_water_level(f32 x, f32 z);

/* |description|
Finds the height of the poison gas at a given position (x, z), if the position is within a gas region. 
If no gas is found, returns the default height of -11000.
|descriptionEnd| */
