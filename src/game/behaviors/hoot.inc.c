    ...
    switch (o->oAction) {
        ...
        case HOOT_ACT_CARRY:
            ...
            if (o->oPosY < 2700.0f) {
                ...
                if (marioState->playerIndex < gNumPlayersLocal && cutscene_object_with_dialog(CUTSCENE_DIALOG, o, gBehaviorValues.dialogs.HootTiredDialog)) {
...
void bhv_hoot_loop(void) {
    ...
    switch (o->oHootAvailability) {
        ...
        case HOOT_AVAIL_WANTS_TO_TALK:
            ...
            if (marioState->playerIndex < gNumPlayersLocal && localTalkToHoot == 0) {
                localTalkToHoot = 1;
            }
