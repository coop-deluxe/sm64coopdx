...
ROM_ASSET_LOAD_ANIM_2D(animdata_mario_mustache_right_1, 0x0027e960, 4920, 0x00000000, 4920, 3);

ROM_ASSET_LOAD_ANIM_2D(animdata_mario_mustache_right_2, 0x0027fc98, 996, 0x00000000, 996, 3);
