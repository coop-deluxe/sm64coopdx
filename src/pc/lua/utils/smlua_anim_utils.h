...
/* |description|Registers an animation with `name` as the identifier that can be used by objects|descriptionEnd| */
...
/* |description|Sets the animation of `obj` to the animation registered with `name`|descriptionEnd| */
