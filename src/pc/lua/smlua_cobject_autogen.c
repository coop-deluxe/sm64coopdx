...
static struct LuaObjectField sCharacterFields[LUA_CHARACTER_FIELD_COUNT] = {
    ...
    { "animOffsetEnabled",                  LVT_U8,       offsetof(struct Character, animOffsetEnabled),                  false, LOT_NONE,        1,              sizeof(u8)                 },
    { "animOffsetFeet",                     LVT_F32,      offsetof(struct Character, animOffsetFeet),                     false, LOT_NONE,        1,              sizeof(f32)                },
    { "animOffsetHand",                     LVT_F32,      offsetof(struct Character, animOffsetHand),                     false, LOT_NONE,        1,              sizeof(f32)                },
    { "animOffsetLowYPoint",                LVT_F32,      offsetof(struct Character, animOffsetLowYPoint),                false, LOT_NONE,        1,              sizeof(f32)                },
    ...
    { "capEnemyDecalGfx",                   LVT_STRING_P, offsetof(struct Character, capEnemyDecalGfx),                   true,  LOT_NONE,        1,              sizeof(char*)              },
    { "capEnemyGfx",                        LVT_STRING_P, offsetof(struct Character, capEnemyGfx),                        true,  LOT_NONE,        1,              sizeof(char*)              },
    { "capEnemyLayer",                      LVT_U8,       offsetof(struct Character, capEnemyLayer),                      false, LOT_NONE,        1,              sizeof(u8)                 },
    { "capMetalModelId",                    LVT_U32,      offsetof(struct Character, capMetalModelId),                    false, LOT_NONE,        1,              sizeof(u32)                },
    { "capMetalWingModelId",                LVT_U32,      offsetof(struct Character, capMetalWingModelId),                false, LOT_NONE,        1,              sizeof(u32)                },
    ...
    { "torsoRotMult",                       LVT_F32,      offsetof(struct Character, torsoRotMult),                       false, LOT_NONE,        1,              sizeof(f32)                },
    { "type",                               LVT_S32,      offsetof(struct Character, type),                               false, LOT_NONE,        1,              sizeof(enum CharacterType) },
};
...
static struct LuaObjectField sMarioStateFields[LUA_MARIO_STATE_FIELD_COUNT] = {
    ...
    { "character",                 LVT_COBJECT_P, offsetof(struct MarioState, character),                 true,  LOT_CHARACTER,         1, sizeof(struct Character*)         },
...
static struct LuaObjectField sNetworkPlayerFields[LUA_NETWORK_PLAYER_FIELD_COUNT] = {
    ...
    { "modelIndex",             LVT_U16,     offsetof(struct NetworkPlayer, modelIndex),             true,  LOT_NONE,          1, sizeof(u16)                  },
    ...
    { "overrideModelIndex",     LVT_U16,     offsetof(struct NetworkPlayer, overrideModelIndex),     false, LOT_NONE,          1, sizeof(u16)                  },
