...
static struct LuaObjectField sObjectFields[LUA_OBJECT_FIELD_COUNT] = {
    ...
    { "apply_scale_to_transform",                     LVT_FUNCTION,            (size_t) "obj_apply_scale_to_transform",                             true,  LOT_NONE,         1,                    sizeof(const char *)          },
...
//  { "areaTimerRunOnceCallback)(void)",              LVT_???,                 offsetof(struct Object, areaTimerRunOnceCallback)(void)),            false, LOT_???,          1,                    sizeof(void (*)               }, <--- UNIMPLEMENTED
    ...
    { "bhv_spawn_star_no_level_exit",                 LVT_FUNCTION,            (size_t) "bhv_spawn_star_no_level_exit",                             true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "build_relative_transform",                     LVT_FUNCTION,            (size_t) "obj_build_relative_transform",                             true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "build_transform_from_pos_and_angle",           LVT_FUNCTION,            (size_t) "obj_build_transform_from_pos_and_angle",                   true,  LOT_NONE,         1,                    sizeof(const char *)          },
    ...
    { "copy_angle",                                   LVT_FUNCTION,            (size_t) "obj_copy_angle",                                           true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "copy_behavior_params",                         LVT_FUNCTION,            (size_t) "obj_copy_behavior_params",                                 true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "copy_graph_y_offset",                          LVT_FUNCTION,            (size_t) "obj_copy_graph_y_offset",                                  true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "copy_pos",                                     LVT_FUNCTION,            (size_t) "obj_copy_pos",                                             true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "copy_pos_and_angle",                           LVT_FUNCTION,            (size_t) "obj_copy_pos_and_angle",                                   true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "copy_scale",                                   LVT_FUNCTION,            (size_t) "obj_copy_scale",                                           true,  LOT_NONE,         1,                    sizeof(const char *)          },
    ...
    { "get_field_s32",                                LVT_FUNCTION,            (size_t) "obj_get_field_s32",                                        true,  LOT_NONE,         1,                    sizeof(const char *)          },
    ...
    { "get_next_with_same_behavior_id",               LVT_FUNCTION,            (size_t) "obj_get_next_with_same_behavior_id",                       true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "get_next_with_same_behavior_id_and_field_f32", LVT_FUNCTION,            (size_t) "obj_get_next_with_same_behavior_id_and_field_f32",         true,  LOT_NONE,         1,                    sizeof(const char *)          },
    ...
    { "init_animation",                               LVT_FUNCTION,            (size_t) "obj_init_animation",                                       true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "init_animation_with_accel_and_sound",          LVT_FUNCTION,            (size_t) "obj_init_animation_with_accel_and_sound",                  true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "init_animation_with_sound",                    LVT_FUNCTION,            (size_t) "obj_init_animation_with_sound",                            true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "is_attackable",                                LVT_FUNCTION,            (size_t) "obj_is_attackable",                                        true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "is_breakable",                                 LVT_FUNCTION,            (size_t) "obj_is_breakable_object",                                  true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "is_bully",                                     LVT_FUNCTION,            (size_t) "obj_is_bully",                                             true,  LOT_NONE,         1,                    sizeof(const char *)          },
...
//  { "ptrData",                                      LVT_???,                 offsetof(struct Object, ptrData),                                    false, LOT_???,          1,                    sizeof(union { ... })         }, <--- UNIMPLEMENTED
    { "queue_rumble_data",                            LVT_FUNCTION,            (size_t) "queue_rumble_data_object",                                 true,  LOT_NONE,         1,                    sizeof(const char *)          },
...
//  { "respawnInfo",                                  LVT_???,                 offsetof(struct Object, respawnInfo),                                false, LOT_???,          1,                    sizeof(void*)                 }, <--- UNIMPLEMENTED
    ...
    { "scale_xyz",                                    LVT_FUNCTION,            (size_t) "obj_scale_xyz",                                            true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "setHome",                                      LVT_U8,                  offsetof(struct Object, setHome),                                    false, LOT_NONE,         1,                    sizeof(u8)                    },
    { "set_angle",                                    LVT_FUNCTION,            (size_t) "obj_set_angle",                                            true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_behavior",                                 LVT_FUNCTION,            (size_t) "obj_set_behavior",                                         true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_billboard",                                LVT_FUNCTION,            (size_t) "obj_set_billboard",                                        true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_collision_data",                           LVT_FUNCTION,            (size_t) "obj_set_collision_data",                                   true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_cutscene_focus",                           LVT_FUNCTION,            (size_t) "set_cutscene_focus",                                       true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_cylboard",                                 LVT_FUNCTION,            (size_t) "obj_set_cylboard",                                         true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_face_angle",                               LVT_FUNCTION,            (size_t) "obj_set_face_angle",                                       true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_face_angle_to_move_angle",                 LVT_FUNCTION,            (size_t) "obj_set_face_angle_to_move_angle",                         true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_field_f32",                                LVT_FUNCTION,            (size_t) "obj_set_field_f32",                                        true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_field_s16",                                LVT_FUNCTION,            (size_t) "obj_set_field_s16",                                        true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_field_s32",                                LVT_FUNCTION,            (size_t) "obj_set_field_s32",                                        true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_field_u32",                                LVT_FUNCTION,            (size_t) "obj_set_field_u32",                                        true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_gfx_angle",                                LVT_FUNCTION,            (size_t) "obj_set_gfx_angle",                                        true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_gfx_pos",                                  LVT_FUNCTION,            (size_t) "obj_set_gfx_pos",                                          true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_gfx_pos_at_obj_pos",                       LVT_FUNCTION,            (size_t) "obj_set_gfx_pos_at_obj_pos",                               true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_gfx_pos_from_pos",                         LVT_FUNCTION,            (size_t) "obj_set_gfx_pos_from_pos",                                 true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_gfx_scale",                                LVT_FUNCTION,            (size_t) "obj_set_gfx_scale",                                        true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_held_state",                               LVT_FUNCTION,            (size_t) "obj_set_held_state",                                       true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_hitbox",                                   LVT_FUNCTION,            (size_t) "obj_set_hitbox",                                           true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_hitbox_radius_and_height",                 LVT_FUNCTION,            (size_t) "obj_set_hitbox_radius_and_height",                         true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_hurtbox_radius_and_height",                LVT_FUNCTION,            (size_t) "obj_set_hurtbox_radius_and_height",                        true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_model_extended",                           LVT_FUNCTION,            (size_t) "obj_set_model_extended",                                   true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_move_angle",                               LVT_FUNCTION,            (size_t) "obj_set_move_angle",                                       true,  LOT_NONE,         1,                    sizeof(const char *)          },
    ...
    { "set_vel",                                      LVT_FUNCTION,            (size_t) "obj_set_vel",                                              true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "set_visibility",                               LVT_FUNCTION,            (size_t) "set_object_visibility",                                    true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "smlua_anim_util_get_current_animation_name",   LVT_FUNCTION,            (size_t) "smlua_anim_util_get_current_animation_name",               true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "smlua_anim_util_set_animation",                LVT_FUNCTION,            (size_t) "smlua_anim_util_set_animation",                            true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "spawn_loot_blue_coins",                        LVT_FUNCTION,            (size_t) "obj_spawn_loot_blue_coins",                                true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "spawn_loot_coins",                             LVT_FUNCTION,            (size_t) "obj_spawn_loot_coins",                                     true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "spawn_loot_yellow_coins",                      LVT_FUNCTION,            (size_t) "obj_spawn_loot_yellow_coins",                              true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "spawn_water_droplet",                          LVT_FUNCTION,            (size_t) "spawn_water_droplet",                                      true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "spawn_yellow_coins",                           LVT_FUNCTION,            (size_t) "obj_spawn_yellow_coins",                                   true,  LOT_NONE,         1,                    sizeof(const char *)          },
    ...
    { "vec3f_to_pos",                                 LVT_FUNCTION,            (size_t) "vec3f_to_object_pos",                                      true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "vec3s_to_face_angle",                          LVT_FUNCTION,            (size_t) "vec3s_to_object_face_angle",                               true,  LOT_NONE,         1,                    sizeof(const char *)          },
    { "vec3s_to_move_angle",                          LVT_FUNCTION,            (size_t) "vec3s_to_object_move_angle",                               true,  LOT_NONE,         1,                    sizeof(const char *)          },
#ifndef VERSION_JP
