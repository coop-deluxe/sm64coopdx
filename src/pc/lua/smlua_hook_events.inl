...
SMLUA_EVENT_HOOK(HOOK_BEFORE_PHYS_STEP, HOOK_RETURN_ON_OUTPUT_SET, struct MarioState *m, s32 stepType, u32 stepArg, OUTPUT s32 *stepResult)
...
SMLUA_EVENT_HOOK_MANUAL(HOOK_ON_HUD_RENDER)
...
SMLUA_EVENT_HOOK(HOOK_OBJECT_SET_MODEL, HOOK_RETURN_NEVER, struct Object *obj, s32 modelID)
...
SMLUA_EVENT_HOOK_MANUAL(HOOK_ON_HUD_RENDER_BEHIND)
...
SMLUA_EVENT_HOOK(HOOK_ON_NAMETAGS_RENDER, HOOK_RETURN_ON_OUTPUT_SET, s32 playerIndex, OUTPUT const char **playerNameOverride)
...
SMLUA_EVENT_HOOK(HOOK_ALLOW_FORCE_WATER_ACTION, HOOK_RETURN_NEVER, struct MarioState *m, bool isInWaterAction, OUTPUT bool *allowActionChange)
