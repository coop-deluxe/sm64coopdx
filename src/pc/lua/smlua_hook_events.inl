...
SMLUA_EVENT_HOOK(HOOK_DIALOG_SOUND, HOOK_RETURN_ON_OUTPUT_SET, s32 speaker, enum DialogId dialogId, OUTPUT s32 *speakerOverride)
...
SMLUA_EVENT_HOOK(HOOK_UPDATE_DELTA_TIME, HOOK_RETURN_NEVER, f32 dt)
SMLUA_EVENT_HOOK(HOOK_ON_RENDER_DELTA_TIME, HOOK_RETURN_NEVER, f32 dt)
