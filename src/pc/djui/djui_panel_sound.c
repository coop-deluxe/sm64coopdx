...
void djui_panel_sound_create(struct DjuiBase* caller) {
    ...
    struct DjuiBase* body = djui_three_panel_get_body(panel);
    {
        ...
        sAudioDevices = gAudioApi->get_speakers(&sNumAudioDevices, &sCurrAudioDevice);
        djui_selectionbox_create(body, DLANG(SOUND, AUDIO_DEVICE), sAudioDevices, sNumAudioDevices, &sCurrAudioDevice, djui_panel_sound_device_change);
    ...
    panel->base.destroy = djui_panel_sound_destroy;
