...
void djui_panel_options_create(struct DjuiBase* caller) {
    ...
    struct DjuiBase* body = djui_three_panel_get_body(panel);
    {
        ...
        djui_button_create(body, DLANG(OPTIONS, CAMERA), DJUI_BUTTON_STYLE_PRIMARY, djui_panel_camera_create);
        djui_button_create(body, DLANG(OPTIONS, CONTROLS), DJUI_BUTTON_STYLE_PRIMARY, djui_panel_controls_create);
        djui_button_create(body, DLANG(OPTIONS, DISPLAY), DJUI_BUTTON_STYLE_PRIMARY, djui_panel_display_create);
        djui_button_create(body, DLANG(OPTIONS, SOUND), DJUI_BUTTON_STYLE_PRIMARY, djui_panel_sound_create);
        djui_button_create(body, DLANG(OPTIONS, MISC), DJUI_BUTTON_STYLE_PRIMARY, djui_panel_misc_create);
        djui_button_create(body, DLANG(MENU, BACK), DJUI_BUTTON_STYLE_SECONDARY, djui_panel_options_back);
    }
