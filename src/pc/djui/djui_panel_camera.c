...
void djui_panel_romhack_camera_create(struct DjuiBase* caller) {
    ...
    struct DjuiBase* body = djui_three_panel_get_body(panel);
    {
        ...
        djui_checkbox_create(body, DLANG(CAMERA, ROMHACK_CAMERA_SWITCHABLE), &configRomhackCameraSwitchable, djui_panel_romhack_camera_value_changed);
        ...
        djui_checkbox_create(body, DLANG(CAMERA, ROMHACK_CAMERA_FOLLOWING), &configRomhackCameraFollowing, djui_panel_romhack_camera_value_changed);
...
void djui_panel_camera_create(struct DjuiBase* caller) {
    ...
    struct DjuiBase* body = djui_three_panel_get_body(panel);
    {
        djui_button_create(body, DLANG(CAMERA, FREE_CAMERA), DJUI_BUTTON_STYLE_PRIMARY, djui_panel_free_camera_create);
        djui_button_create(body, DLANG(CAMERA, ROMHACK_CAMERA), DJUI_BUTTON_STYLE_PRIMARY, djui_panel_romhack_camera_create);
