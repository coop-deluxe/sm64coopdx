...
void djui_panel_host_settings_create(struct DjuiBase* caller) {
    ...
    struct DjuiBase* body = djui_three_panel_get_body(panel);
    {
        ...
        char* pChoices[3] = { DLANG(HOST_SETTINGS, DEFAULT_PVP), DLANG(HOST_SETTINGS, CLASSIC_PVP), DLANG(HOST_SETTINGS, REVAMPED_PVP) };
        djui_selectionbox_create(body, DLANG(HOST_SETTINGS, PVP_MODE), pChoices, 3, &configPvpType, NULL);
