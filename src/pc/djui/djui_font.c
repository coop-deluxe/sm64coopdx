...
static void djui_font_normal_render_char(char* c) {
    ...
    if (index & 0x010000) {
        ...
        djui_gfx_render_font_char(texture_font_jp, 512, 1024, G_IM_FMT_RGBA, G_IM_SIZ_32b, tx * 8, ty * 16, 8, 16);
    } else {
        u32 tx = index % 32;
        u32 ty = index / 32;
        extern ALIGNED8 const Texture texture_font_normal[];
        djui_gfx_render_font_char(texture_font_normal, 256, 128, G_IM_FMT_RGBA, G_IM_SIZ_32b, tx * 8, ty * 16, 8, 16);
    }
}
...
static void djui_font_title_render_char(char* c) {
    ...
    djui_gfx_render_font_char(texture_font_title, 1024, 512, G_IM_FMT_RGBA, G_IM_SIZ_32b, tx * 64, ty * 64, 64, 64);
}
...
static void djui_font_aliased_render_char(char* c) {
    ...
    if (index & 0x010000) {
        ...
        djui_gfx_render_font_char(texture_font_jp_aliased, 1024, 2048, G_IM_FMT_RGBA, G_IM_SIZ_32b, tx * 16, ty * 32, 16, 32);
    } else {
        u32 tx = index % 32;
        u32 ty = index / 32;
        extern ALIGNED8 const Texture texture_font_aliased[];
        djui_gfx_render_font_char(texture_font_aliased, 512, 256, G_IM_FMT_RGBA, G_IM_SIZ_32b, tx * 16, ty * 32, 16, 32);
    }
}
...
static void djui_font_custom_hud_render_char(char* c) {
    ...
    djui_gfx_render_font_char(texture_font_hud, 512, 512, G_IM_FMT_RGBA, G_IM_SIZ_32b, tx * 32, ty * 32, 32, 32);
}
...
static void djui_font_custom_hud_recolor_render_char(char* c) {
    ...
    djui_gfx_render_font_char(texture_font_hud_recolor, 512, 512, G_IM_FMT_RGBA, G_IM_SIZ_32b, tx * 32, ty * 32, 32, 32);
}
...
static void djui_font_special_render_char(char* c) {
    ...
    if (index & 0x010000) {
        ...
        djui_gfx_render_font_char(texture_font_special, 256, 128, G_IM_FMT_RGBA, G_IM_SIZ_32b, tx * 8, ty * 16, 8, 16);
    }
