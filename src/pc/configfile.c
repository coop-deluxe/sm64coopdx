...
unsigned int configKeyR[MAX_BINDS]                = { 0x0036,     0x100A,     0x1016     };
unsigned int configKeyZ[MAX_BINDS]                = { 0x0025,     0x1007,     0x1015     };
unsigned int configKeyCUp[MAX_BINDS]              = { 0x0148,     0x101D, VK_INVALID };
unsigned int configKeyCDown[MAX_BINDS]            = { 0x0150,     0x101E, VK_INVALID };
unsigned int configKeyCLeft[MAX_BINDS]            = { 0x014B,     0x101B, VK_INVALID };
unsigned int configKeyCRight[MAX_BINDS]           = { 0x014D,     0x101C, VK_INVALID };
