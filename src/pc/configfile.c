...
// display settings
enum GfxBackend configGraphicsBackend             = GFX_BACKEND_OPENGL;
...
NEXT_OPTION:
    ...
    if (configGraphicsBackend < GFX_BACKEND_OPENGL || configGraphicsBackend > GFX_BACKEND_MAX) { configGraphicsBackend = GFX_BACKEND_OPENGL; }
