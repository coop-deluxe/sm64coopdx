...
function obj_spawn_loot_coins(obj, numCoins, initialVelY, coinBehavior, posJitter, model)
    -- ...
end
...
function obj_spawn_loot_blue_coins(obj, numCoins, initialVelY, posJitter)
    -- ...
end
...
function obj_spawn_loot_yellow_coins(obj, numCoins, initialVelY)
    -- ...
end
...
function obj_explode_and_spawn_coins(particleSize, coinType)
    -- ...
end
