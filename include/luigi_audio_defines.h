...
#define SOUND_LUIGI_SNORING1         SOUND_ARG_LOAD(0x0A, 4, 0x0E, 0x00, 8)
#define SOUND_LUIGI_SNORING2         SOUND_ARG_LOAD(0x0A, 4, 0x0F, 0x00, 8)
...
#define SOUND_LUIGI_SNORING3                    SOUND_ARG_LOAD(0x0A, 4, 0x35, 0x00, 8)
