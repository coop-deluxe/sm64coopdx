...
const GeoLayout wf_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -625, 883, 5125, 0, 90, -90, wf_dl_Boxes_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, -100, 0, wf_dl_Level_Geometry_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
