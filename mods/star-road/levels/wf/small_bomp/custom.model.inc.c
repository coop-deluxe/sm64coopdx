...
static const Vtx wf_seg7_vertex_0700D388[] = {
    {{{     0,    192,   -193}, 0, { -1024,   1024}, {0x00, 0x00, 0x00, 0xff}}},
    {{{     0,   -192,    193}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{     0,    192,    193}, 0, {     0,   1024}, {0x00, 0x00, 0x00, 0xff}}},
    {{{     0,   -192,    193}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{     0,    192,   -193}, 0, { -1024,   1024}, {0x00, 0x00, 0x00, 0xff}}},
    {{{     0,   -192,   -193}, 0, { -1024,      0}, {0x00, 0x00, 0x00, 0xff}}},
