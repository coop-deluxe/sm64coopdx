...
ifeq ($(TARGET_WEB),1)
  LDFLAGS := $(OPT_FLAGS) $(BACKEND_LDFLAGS) \
    ...
    -s EXPORTED_FUNCTIONS='["_main","_rom_on_drop_file","_web_rom_loaded","_web_get_rom_status","_web_save_to_idb","_web_fs_init","_web_one_iteration","_malloc","_free","_web_get_player_count","_web_get_player_connected","_web_get_player_name","_web_get_player_location","_web_get_local_player_index","_web_is_in_game","_web_teleport_to_player"]' \
    -s ASYNCIFY \
