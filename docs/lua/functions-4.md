...
### Lua Example
`local PointerValue = vec3f_normalize(dest)`
...
### C Prototype
`f32 *vec3f_normalize(Vec3f dest);`

[:arrow_up_small:](#)

<br />

## [vec3f_normalize2](#vec3f_normalize2)

### Description
Normalizes each component of the 3D floating-point vector 'v'.

### Lua Example
`local PointerValue = vec3f_normalize2(v)`
