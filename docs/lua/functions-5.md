...
---
# functions from mod_socket.h

<br />


## [mod_socket_allowed](#mod_socket_allowed)

### Description
Retured whether external functions are allowed by the user

### Lua Example
`local booleanValue = mod_socket_allowed()`
...
## [mod_socket_init](#mod_socket_init)

### Description
Initializes the current socket with the provided IP, Port, and TCP/UDP state

### Lua Example
`local booleanValue = mod_socket_init(ip, port, TCP)`
...
## [mod_socket_disconnect](#mod_socket_disconnect)
...
## [mod_socket_send](#mod_socket_send)
...
## [mod_socket_is_connected](#mod_socket_is_connected)

### Description
Returns whether the current socket is open or not

### Lua Example
`local booleanValue = mod_socket_is_connected()`
...
## [mod_socket_update](#mod_socket_update)
