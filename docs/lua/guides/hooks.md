...
| HOOK_ALLOW_FALL_DAMAGE | Called when the local player takes fall damage, return `false` to prevent taking fall damage | [MarioState](../structs.md#MarioState) mario |
