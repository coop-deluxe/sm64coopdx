...
| HOOK_ON_INSTANT_WARP | Called when the local player goes through an instant warp.| `integer` destLevel, `integer` destArea, `integer` destAreaWarpNode, `integer` arg |
