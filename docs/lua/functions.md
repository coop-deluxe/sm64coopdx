...
- mario_actions_cutscene.c
   ...
   - [set_mario_npc_dialog](functions-4.md#set_mario_npc_dialog)
...
- mario_actions_moving.c
   ...
   - [common_landing_cancels](functions-4.md#common_landing_cancels)
...
- obj_behaviors.c
   ...
   - [trigger_obj_dialog_when_facing](functions-5.md#trigger_obj_dialog_when_facing)
...
- object_helpers.c
   ...
   - [cur_obj_update_dialog](functions-6.md#cur_obj_update_dialog)
   - [cur_obj_update_dialog_with_cutscene](functions-6.md#cur_obj_update_dialog_with_cutscene)
