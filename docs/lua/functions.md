...
- smlua_gfx_utils.h
   ...
   - [gfx_clear_geometrymode](functions-5.md#gfx_clear_geometrymode)
   ...
   - [gfx_set_geometrymode](functions-5.md#gfx_set_geometrymode)
   - [gfx_set_prim_color](functions-5.md#gfx_set_prim_color)
   - [gfx_set_render_mode](functions-5.md#gfx_set_render_mode)
